...
SWITCH_BUTTON_NUMBER = 7  # Which joystick axis represents the switch

# Joystick event types
EVENT_TYPE_BUTTON = 1  # Button/switch event
EVENT_TYPE_AXIS = 2    # Axis event

# Switch value thresholds for axis
# Axis positive (value>0) = UDP mode, Axis negative/zero (value<=0) = Joystick mode
